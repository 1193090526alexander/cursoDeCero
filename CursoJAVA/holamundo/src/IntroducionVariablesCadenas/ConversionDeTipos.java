...
public class ConversionDeTipos {
    public static void main(String[] args) {
        ...
        System.out.println("nuevoNumeroInt = " + nuevoNumeroInt);
        String otroNumeroStr = Integer.toString(nuevoNumeroInt);

        otroNumeroStr = String.valueOf(otroNumeroStr+100);
        System.out.println("otroNumeroStr = " + otroNumeroStr);

        double otroRealDouble = 12312.43;
        String otroRealStr = Double.toString(otroRealDouble);
        System.out.println("otroRealStr = " + otroRealStr);

        otroRealStr = String.valueOf(1.2323e2f);
        System.out.println("otroRealStr = " + otroRealStr);
